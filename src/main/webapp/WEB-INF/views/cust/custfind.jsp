...
$(document).ready(function(){
	...
	$("#btnGetLoginId").on("click", function(){
		...
		$.ajax({
			...
			if(result == "" && result == null){
				...
				$("#modalFrom").append("<div id='modalPU'><span> 회원님의 아이디는 " + result + " 입니다.</span>"
									+/*  "<input type='button' id='btnClose' value='닫기' />" */" </div>")
	...
	$("#btnGetLoginPassword").on("click", function(){
		...
		paramObj.cust_phone = $("#cust_phone").val();
		
		$.ajax({
			url: "/violet/cust/getLoginPassword",
			type: 'POST',
			data: paramObj
			...
			if(result == "" && result == null){
				...
				$("#modalFrom").append("<div id='modalPU'><span> 회원님의 비밀번호는 " + result + " 입니다.</span>"
									+/*  "<input type='button' id='btnClose' value='닫기' />" */" </div>")
			}
		})
	})	
...
<body>
	...
	<div id="getLoignPasswordForm">
		...
		<input type="text" id="cust_phone" value="" placeholder="연락처" /><br/><br/>
