...
public class CustDAOImpl implements CustDAO {
	...
	public String custFindId(CustVO custVO) throws Exception {
		return sql.selectOne("CustMapper.custFindId", custVO);
	}

	// 비밀번호 찾기
	@Override
	public String custFindPassword(CustVO custVO) throws Exception {
		return sql.selectOne("CustMapper.custFindPassword", custVO);
	}
	 ...
	 * // 비밀번호 찾기
	 * 
	 * @Override public String getLoginPassword(CustVO custVO) throws Exception {
